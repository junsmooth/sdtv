...
import com.potevio.sdtv.service.ythtjr.BedMSG;
import com.potevio.sdtv.service.ythtjr.BedMsgHandler;
import com.potevio.sdtv.service.ythtjr.BedServer;
...
public class BedTimer {
	...
	private void sendDataToPlatform() throws Exception {
		...
		while (true) {
			BedMSG msg;
			try {
				msg = (BedMSG) BedMsgHandler.getQueue().take();
				sendBedMsg(msg);
