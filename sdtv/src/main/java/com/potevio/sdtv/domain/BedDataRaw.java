...
public class BedDataRaw {
	...
	public String toString() {
		return "BedData [id=" + id + ", seriesId=" + seriesId + ", patname="
				+ patname + ", occurTime=" + occurTime + ", status=" + status
				+ ", statusName=" + statusName + ", heartrating=" + heartrating
				+ ", resping=" + resping + ", warn=" + warn + "]";
	}
